...
bot = telebot.TeleBot('5890510320:AAEGlhed7wmkxJjxIrAiwahqNxVXyHUesR8')

def webAppKeyboard(): #создание клавиатуры с webapp кнопкой
   keyboard = types.ReplyKeyboardMarkup(row_width=1) #создаем клавиатуру
   webAppTest = types.WebAppInfo("https://web.telegram.org/z/#5890510320") #создаем webappinfo - формат хранения url
   # webAppGame = types.WebAppInfo("https://games.mihailgok.ru") #создаем webappinfo - формат хранения url
   one_butt = types.KeyboardButton(text="Сонник", web_app=webAppTest) #создаем кнопку типа webapp
